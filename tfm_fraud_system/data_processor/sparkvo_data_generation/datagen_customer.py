...
def make_cities():
    cities = {}
    # tfm_fraud_system / data_processor / sparkvo_data_generation / demographic_data
    current_path = os.path.dirname(__file__)
    file_url = os.path.join(current_path,'./demographic_data/locations_partitions.csv')
...
def make_age_gender_dict():
    ...
    prev = 0
    current_path = os.path.dirname(__file__)
    file_url = os.path.join(current_path, './demographic_data/age_gender_demographics.csv')
